...
plot(datetime, mod_data$Voltage, type="l", xlab="datetime",ylab="Voltage")
...
plot(datetime, mod_data$Global_reactive_power, type="l", xlab="Global_reactive_power",ylab="datetime")
dev.off()